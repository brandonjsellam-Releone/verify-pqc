...
node fuzz-robustness.mjs     # negative/fuzz sweep (58 verifiers × 72 adversarial input classes = 4,176 calls) — asserts 0 fail-open + verifier totality
...
node domain-separation.mjs   # 0 bare sign/verify (179 sites), 60 distinct contexts, cross-context rejection
node canon-determinism.mjs   # canon() byte-identical across 26 modules + deterministic/injective
```
