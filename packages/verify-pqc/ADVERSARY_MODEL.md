...
| Malformed/adversarial input to a verifier | No crash (fail-closed) | `fuzz-robustness.mjs`: 4,248 calls (59 verifiers × 72 input classes), no throw observed; `tamper-binding.mjs` 832-assertion field-binding coverage |
